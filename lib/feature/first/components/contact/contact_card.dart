...
class ContactCard extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    return div(classes: "w-full scroll-reveal", [
      a(
        href: herf,
        classes:
            "block bg-cardColor rounded-lg p-5 sm:py-4 hover:scale-102 hover:-translate-y-1 hover:shadow-2xl hover:shadow-[#C4B896]/20 hover:border-[#C4B896]/30 transition-all duration-300 ease-out cursor-pointer flex flex-col justify-center border border-transparent",
        [
